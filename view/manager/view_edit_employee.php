    ...
    <div class="w-full flex flex-col h-screen overflow-y-hidden">
        ...
        <div class="w-full overflow-x-hidden border-t flex flex-col">
            <main class="w-full flex-grow p-6">
                ...
                <form action="../../controller/manager/edit_employee_controller.php" method="POST"
                    class="max-w-4xl mx-auto bg-white p-8 rounded-xl shadow-md space-y-6">

                    <h2 class="text-2xl font-semibold text-gray-800">แก้ไขข้อมูลพนักงาน</h2>
                    <p class="text-gray-500">กรุณาแก้ไขข้อมูลพนักงานให้ครบถ้วน</p>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input name="fname" type="text" placeholder="ชื่อ" value="<?= $employee['fname']; ?>" required
                                class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400">
                        </div>
                        <div>
                            <label class="block mb-1 text-gray-700">นามสกุล</label>
                            <input name="lname" type="text" placeholder="นามสกุล" value="<?= $employee['lname']; ?>" required
                                class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400">
                        </div>
                        <div>
                            <label class="block mb-1 text-gray-700">ชื่อเล่น</label>
                            <input name="nick_name" type="text" placeholder="ชื่อเล่น" value="<?= $employee['nick_name']; ?>"
                                class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400">
                        </div>
                        <div>
                            <label class="block mb-1 text-gray-700">จำนวนวันลา</label>
                            <input name="leave_days" type="number" placeholder="จำนวนวันลา" value="<?= $employee['leave_days']; ?>"
                                class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400">
                        </div>
                        <div>
                            <label class="block mb-1 text-gray-700">ค่าแรง / วัน</label>
                            <input name="wage_per_date" type="number" placeholder="ค่าแรง / วัน" value="<?= $employee['wage_per_date']; ?>"
                                class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400">
                        </div>
                        <div>
                            <label class="block mb-1 text-gray-700">จำนวนวัน</label>
                            <input name="num_of_work_date" type="number" placeholder="จำนวนวัน" value="<?= $employee['num_of_work_date']; ?>"
                                class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400">
                        </div>
                        <div>
                            <label class="block mb-1 text-gray-700">บวกค่ากะ</label>
                            <input name="shift_fee" type="number" placeholder="บวกค่ากะ" value="<?= $employee['shift_fee']; ?>"
                                class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400">
                        </div>
                        <div>
                            <label class="block mb-1 text-gray-700">OT / ชั่วโมง</label>
                            <input name="ot_per_hour" type="number" placeholder="OT / ชั่วโมง" value="<?= $employee['ot_per_hour']; ?>"
                                class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400">
                        </div>
                        <div>
                            <label class="block mb-1 text-gray-700">จำนวนชั่วโมง OT</label>
                            <input name="num_of_ot_hours" type="number" placeholder="จำนวนชั่วโมง OT" value="<?= $employee['num_of_ot_hours']; ?>"
                                class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400">
                        </div>
                    </div>
