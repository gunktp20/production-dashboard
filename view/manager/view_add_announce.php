...
<body class="bg-gray-100 font-family-karla flex">
    ...
    <aside class="relative bg-white h-screen w-[350px] hidden sm:block shadow-xl">
        ...
        <nav class="text-white text-base font-semibold pt-3">
            ...
            <a href="./view_add_announce.php" class="flex items-center py-4 pl-4 nav-item text-[#4195fc] text-sm bg-[#e9f3ff]">
    ...
    <div class="w-full flex flex-col h-screen overflow-y-hidden">
        ...
        <div class="w-full overflow-x-hidden border-t flex flex-col">
            <main class="w-full flex-grow p-6">
                ...
                <form action="../../controller/manager/add_announce_controller.php" method="POST"
                    class="max-w-4xl mx-auto bg-white p-8 rounded-xl shadow-md space-y-6">

                    <h2 class="text-2xl font-semibold text-gray-800">ประกาศข่าวสาร</h2>
                    <p class="text-gray-500">เพิ่มข่าวสารเพื่อแจ้งพนักงานของคุณ</p>
                    ...
                    <div class="grid grid-cols-1 gap-6">
                        <div>
                            <label for="announce" class="block mb-1 text-gray-700">ประกาศข่าวสาร</label>
                            <input name="announce" id="announce" type="text" placeholder="ประกาศข่าวสาร" required
                                class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400">
                        </div>
                    </div>

                    <div class="flex flex-wrap gap-4 justify-start pt-4">
                        <button type="submit" name="add_announce"
                            class="bg-blue-500 hover:bg-blue-600 text-white font-medium py-2 px-6 rounded-md transition">
                            📢 ยืนยันการเพิ่มข่าวสาร
                        </button>
                        <a href="./view_announces.php"
