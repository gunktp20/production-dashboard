...
<body class="bg-gray-100 font-family-karla flex">
  ...
  <aside class="relative bg-white h-screen w-[350px] hidden sm:block shadow-xl">
    ...
    <nav class="text-white text-base font-semibold pt-3">
      ...
      <a href="./view_employees_contact.php" class="flex items-center py-4 pl-4 nav-item text-[#4195fc] text-sm bg-[#e9f3ff]">
    ...
    <?php else : ?>
      ...
      <div class="w-full overflow-x-hidden border-t flex flex-col">
        <main class="w-full flex-grow p-6">
          <h1 class="text-3xl text-black pb-6">ช่องทางการติดต่อพนักงาน</h1>
            ...
            <table id="employee" class="bg-white shadow rounded w-full text-sm">
              ...
              <?php foreach ($result2 as $row) : ?>
                <tr>
                  ...
                  <td><?= $row["email"] ?></td>
                  <td class="option-col">
                    <a class="edit-btn" href="./view_edit_employee_contact.php?id=<?= $row['id'] ?>">แก้ไข</a>
