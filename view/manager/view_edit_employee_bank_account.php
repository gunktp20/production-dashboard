    ...
    <div class="w-full flex flex-col h-screen overflow-y-hidden">
        ...
        <div class="w-full overflow-x-hidden border-t flex flex-col">
            <main class="w-full flex-grow p-6">
                ...
                <form action="../../controller/manager/edit_employee_bank_account_controller.php" method="POST"
                    class="max-w-4xl mx-auto bg-white p-8 rounded-xl shadow-md space-y-6">

                    <h2 class="text-2xl font-semibold text-gray-800">แก้ไขข้อมูลบัญชีธนาคาร</h2>
                    <p class="text-gray-500">กรุณาแก้ไขข้อมูลบัญชีธนาคารของพนักงานให้ครบถ้วน</p>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <label for="bank_account" class="block mb-1 text-gray-700">บัญชีธนาคารของ</label>
                            <input name="bank_account" id="bank_account" type="text" placeholder="บัญชีธนาคารของ"
                                value="<?= $employee['bank_account']; ?>"
                                class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400">
                        </div>
                        <div class="md:col-span-2">
                            <label for="bank_account_number" class="block mb-1 text-gray-700">เลขบัญชีธนาคาร</label>
                            <input name="bank_account_number" id="bank_account_number" type="text" placeholder="เลขบัญชีธนาคาร"
                    ...
                    <div class="flex flex-wrap gap-4 justify-start pt-4">
                        ...
                        <a href="./view_employees_bank.php"
